...
\title{AMORPH: A statistical program for characterizing amorphous materials by X-ray diffraction$^1$\footnotetext{\changed $^1$MR conceived the project, developed geologic applications, and drafted the manuscript with BB. BB developed the statistical model, wrote the program code, and co-wrote the manuscript.}}
...
\begin{abstract}
AMORPH utilizes a new Bayesian statistical approach to interpreting X-ray diffraction results of {\changed samples with both crystalline and amorphous components}. AMORPH fits X-ray diffraction patterns with a mixture of {\changed narrow and wide components},
{\changed simultaneously inferring} all of the model parameters and {\changed quantifying} their
uncertainties.
The program simulates background patterns previously {\changed applied manually}, providing reproducible results, and significantly reducing inter- and intra-user biases. This approach allows for the quantification of amorphous and crystalline materials and for the characterization of the amorphous component, including {\changed properties such as the} centre of mass, width, skewness, and nongaussianity of the amorphous component. Results demonstrate the applicability of this program for calculating amorphous contents of volcanic materials and independently modeling their properties in compositionally variable materials.
\end{abstract}
...
such as the widths of the narrow peaks. } %changed
...
\begin{figure}[!ht]
  \begin{minipage}{\textwidth}
    \centering
    \includegraphics[width=0.99\textwidth]{figures/residuals2.pdf} \\
    \includegraphics[width=0.99\textwidth]{figures/residuals1.pdf}
  \end{minipage}
...
\begin{figure}[!ht]
  \begin{minipage}{\textwidth}
    \centering
    \includegraphics[width=0.99\textwidth]{figures/numpeaks2.pdf} \\
    \includegraphics[width=0.99\textwidth]{figures/numpeaks1.pdf}
  \end{minipage}
...
{\changed 
\bibitem[Brewer et al.(2013)]{starfield}
...
{\changed 
\bibitem[Clark(1980)]{clean} Clark, B. G.
...
{\changed 
\bibitem[Hobson \& McLachlan(2003)]{hobson} Hobson, M.~P., \& McLachlan, C.\ 2003, \mnras, 338, 765 
}
...
{\changed 
\bibitem[Padayachee et al.(1999)]{padayachee}
...
{\changed 
\bibitem[Worpel and Schwope(2015)]{worpel}
